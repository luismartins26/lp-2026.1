...
-- Nota: Adicionado 'deriving (Eq, Show)' para permitir que os testes comparem e imprimam resultados
...
-- DICA DE TESTE: O teste espera o formato "(e1 + e2)" para Add e "(e1 - e2)" para Sub.
